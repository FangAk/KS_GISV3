define([
  ...
  return declare([GraphicsLayer], {
    constructor: function (options, callback) {
      ...
      this._zoomEnd = null;
      this.getCurrentSingles = callback;
    },
    ...
    onClick: function (e) {
      ...
      if (singles.length > this._maxSingles) {
        ...
        this.getCurrentSingles(singles);
      }
    },

    // internal methods
    _clusterGraphics: function () {
      // const playerList = this.map.getLayer("cluster2");
    ...
    _changeClusterGraphics: function (list, that) {
      that._clusterData = list;
      that.clear();
